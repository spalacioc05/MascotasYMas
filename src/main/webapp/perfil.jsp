...
<head>
    ...
    <title>Perfil de Usuario - MASCOTAS & MÁS</title>
    <!-- Favicon-->
...
<main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="index.jsp">MASCOTAS & MÁS - CLIENTE</a>
            ...
            <div class="col-lg-10 col-xl-9 mx-auto">
                <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                    <div class="card-body p-4 p-sm-5">
                        <h5 class="card-title text-center mb-5 fw-light fs-5">Perfil de Usuario</h5>
                        <!-- Tabs navs -->
                        ...
                        <div class="tab-content" id="ex1-content">
                            ...
                            <div class="tab-pane fade" id="edit" role="tabpanel" aria-labelledby="tab-edit">
                                <form action="EditClientProfileServlet" method="post">
                                    <!-- Campo de Identificación -->
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInputId" value="<%= usuario.getId() %>" readonly>
                                        <label for="floatingInputId">Identificación</label>
                                    ...
                                    <div class="d-grid mb-2">
                                        <button class="btn btn-lg btn-danger btn-login fw-bold text-uppercase" type="button" onclick="confirmDelete()">Eliminar Cuenta</button>
                                    </div>
                                    
                                </form>
                            </div>
                            <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="tab-password">
                                <form action="ChangeClientPasswordServlet" method="post">
...
<script>
    function confirmDelete() {
        if (confirm("¿Está seguro de que desea eliminar su cuenta? Esta acción no se puede deshacer.")) {
            window.location.href = 'DeleteClientAccountServlet';
        }
    }
</script>
</body>
